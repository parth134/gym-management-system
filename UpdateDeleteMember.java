...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
           ...
           if(checkid==0){
               JOptionPane.showMessageDialog(null, "Message ID does not Exist");
           }
        }
        catch(Exception e){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
           Connection con=ConnectionProvider.getCon();
           PreparedStatement ps=con.prepareStatement("update member set name=?, mobilenumber=?, email=?, fathername=?, mothername=?, aadharnumber=?,amount=? where id=?");
           ps.setString(1, name);
